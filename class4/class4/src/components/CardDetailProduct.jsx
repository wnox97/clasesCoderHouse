...
export default function CardDetailProduct({title, description, price, img}){
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      <img alt="ecommerce" className="lg:w-1/2 w-full object-cover object-center rounded border border-gray-200" src={img ?? 'https://www.whitmorerarebooks.com/pictures/medium/2465.jpg'} />
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <div className="flex">
          <span className="title-font font-medium text-2xl text-gray-900">${Number(price).toLocaleString('en-EN')}</span>
          <button 
